...
('G001', 'Daun Menguning', 'Daun', 'Apel'),
('G002', 'Warna jaringan akar coklat', 'Akar', 'Apel'),
('G003', 'Warna jaringan batang coklat', 'Batang', 'Apel'),
('G004', 'Akar membusuk', 'Akar', 'Apel'),
('G005', 'Buah kecil', 'Buah/Umbi', 'Apel'),
('G006', 'Buah gugur', 'Buah/Umbi', 'Apel'),
('G007', 'Daun layu', 'Daun', 'Apel'),
('G008', 'Jaringan sekuler bawah batang kecoklatan', 'Batang', 'Apel'),
('G009', 'Akar menjadi Kecoklatan', 'Akar', 'Apel'),
('G010', 'Warna buah kekuningan', 'Buah/Umbi', 'Apel'),
('G011', 'Buah membusuk', 'Buah/Umbi', 'Apel'),
('G012', 'Terdapat bercak bulat dan kering pada daun', 'Daun', 'Apel'),
('G013', 'Bercak pada daun berwarna pucat sampai putih', 'Daun', 'Apel'),
('G014', 'Bercak pada daun menyerupai mata kodok (frogeyes) ', 'Daun', 'Apel'),
('G015', 'Terdapat bercak pada batang ', 'Batang', 'Apel'),
('G016', 'Bercak kecil coklat kehitaman pada buah', 'Buah/Umbi', 'Apel'),
('G017', 'Buah keriput', 'Buah/Umbi', 'Apel'),
('G018', 'Warna kulit buah seperti jerami padi', 'Buah/Umbi', 'Apel'),
('G019', 'Terdapat bercak kecil kebasah-basahan pada buah ', 'Buah/Umbi', 'Apel'),
('G020', 'Buah mengering', 'Buah/Umbi', 'Apel'),
('G021', 'Biji yang \r\nterserang menjadi coklat\r\n', 'Biji', 'Apel'),
('G022', 'biji yang terserang menjadi keriput ', 'Biji', 'Apel'),
('G023', 'Daun melengkung ke bawah ', 'Daun', 'Apel'),
('G024', 'Daun berwarna hijau pekat ', 'Daun', 'Apel'),
('G025', 'Permukaan daun tidak rata', 'Daun', 'Apel'),
('G026', 'Daun terkesan regas seperti kerupuk ', 'Daun', 'Apel'),
('G027', 'Daun mati', 'Daun', 'Apel'),
('G028', 'Bunga dan Bakal buah berguguran', 'Bunga', 'Apel'),
('G029', 'Warna daun belang ', 'Daun', 'Apel'),
('G030', 'Daun cekung ', 'Daun', 'Apel'),
('G031', 'Daun mengeriting ', 'Daun', 'Apel'),
('G032', 'Daun memanjang ', 'Daun', 'Apel'),
('G033', 'Bentuk daun menyempit', 'Daun', 'Apel'),
('G034', 'pertumbuhan tanaman terhambat ', 'Batang', 'Apel'),
('G035', 'Helai daun mengalami “vein clearing”', 'Daun', 'Apel'),
('G036', 'Pucuk daun berwarna kuning jelas', 'Daun', 'Apel'),
('G037', 'tulang daun menebal', 'Daun', 'Apel'),
('G038', 'Daun menggulung keatas', 'Daun', 'Apel'),
('G039', 'Daun menyusut', 'Daun', 'Apel'),
('G041', 'Warna daun berubah menjadi warna tembaga/kecoklatan', 'Daun', 'Apel'),
('G042', 'Daun terpuntir', 'Daun', 'Apel'),
('G043', 'Tunas dan bunga gugur ', 'Bunga', 'Apel'),
('G044', 'Permukaan bawah daun berwarna keperak-perakan', 'Daun', 'Apel'),
('G045', 'Bercak daun berwarna putih', 'Daun', 'Apel'),
('G046', 'Daun mengering ', 'Daun', 'Apel'),
('G047', 'Daun keriput ', 'Daun', 'Apel'),
('G048', 'Daun timbul benjolan seperti tumor ', 'Daun', 'Apel'),
('G049', 'Pucuk tanaman mati', 'Batang', 'Apel'),
('G050', 'Tanaman menjadi keriput ', 'Batang', 'Apel'),
('G051', 'Warna daun kekuningan', 'Daun', 'Apel'),
('G052', 'Sel-sel dan jaringan daun rusak', 'Daun', 'Apel'),
('G053', 'Bercak nekrotik pada daun ', 'Daun', 'Apel'),
('G054', 'Daun transparan', 'Daun', 'Apel'),
('G055', 'Timbul lubang yang tidak beraturan pada buah ', 'Buah/Umbi', 'Apel'),
('G056', 'Daun rusak ', 'Daun', 'Apel'),
('G057', 'Tanaman gundul', 'Batang', 'Apel'),
('G058', 'Buah berlubang ', 'Buah/Umbi', 'Apel'),
('G059', 'Terdapat titik coklat kehitaman pada pangkal buah', 'Buah/Umbi', 'Apel'),
('G060', 'Pangkal buah berlubang ', 'Buah/Umbi', 'Apel'),
('G061', 'Buah jatuh ke tanah ', 'Buah/Umbi', 'Apel'),
...
('G071', 'Daun menjadi kering dan warna daun seperti terbakar', 'Daun', 'Apel'),
('G072', 'Daun terdapat bercak melekuk ', 'Daun', 'Bawang'),
('G073', 'Bercak daun berwarna putih atau kelabu ', 'Daun', 'Apel'),
('G074', 'Bercak daun memebentuk zona berwarna ungu jika sudah parah', 'Daun', 'Apel'),
('G075', 'Ujung daun kering ', 'Daun', 'Apel'),
