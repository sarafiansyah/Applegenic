        ...
        <nav class="nav">
            <div>
                ...
                <div class="nav_list">
                    ...
                    <a href="hamadanpenyakit.php" class="nav_link">
                        <i class="bx bx-user nav_icon"></i> <span class="nav_name">Manage Diagnosis</span>
                    </a>
                    <a href="basispengetahuan.php" class="nav_link">
                        <i class="bx bx-message-square-detail nav_icon"></i>
                        <span class="nav_name">Manage Diseases</span>
                    </a>
